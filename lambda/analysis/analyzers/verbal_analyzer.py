...
5. 태도 인상 (attitude_comment): 면접관 관점 태도/말투 인상. 3줄 형식: ✓ 긍정 / △ 부정 / → 개선. 구체적 근거(어떤 표현/어투) 제시 필수.
...
def analyze_verbal(
    ...
    for attempt in range(MAX_RETRIES):
        try:
            ...
            if "attitude_comment" not in result:
                print("[Verbal] attitude_comment 누락 — LLM 응답에 필드 없음")
