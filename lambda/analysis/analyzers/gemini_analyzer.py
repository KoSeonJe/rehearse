...
- 필러: "음/어/그/아/뭐/이제/약간/좀/그러니까" (포함). "예/네"는 응대 어휘 — **필러 제외**. 반복 시작·도입부 집중 확인.
...
### 3. verbal — 답변 내용 전달력
**관점**: 기술 정확성은 technical에서 다룸. verbal은 "답변의 구조·순서·핵심 용어 명확성"만 평가. 평가 축: (a) 핵심 용어 정확 호명 (b) 예시·수치 구체화 (c) 결론→근거→예시 구조 (d) 질문 외 내용 누설 여부. 답변 개념을 큰따옴표로 인용해 서술.
