    ...
    <div className="min-h-screen bg-white text-text-primary">
      ...
      <main className="mx-auto max-w-3xl px-5 md:px-8 py-12">
          ...
          <ol className="space-y-1.5 text-sm">
            {[
              ...
              <li key={href}>
                <a
                  href={href}
                  className="text-text-secondary hover:text-violet-legacy transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-legacy focus-visible:ring-offset-1 rounded-sm"
                >
                  {label}
                </a>
              </li>
          ...
          <Section id="contact" title="10. 문의처">
            ...
            <p className="mt-2">
              ...
              <a
                ...
                className="text-violet-legacy hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-legacy focus-visible:ring-offset-1 rounded-sm"
              >
        ...
        <div className="mt-12 pt-6 border-t border-border flex items-center justify-between gap-4">
          ...
          <Link
            to="/"
            className="text-xs font-medium text-text-secondary transition-colors hover:text-text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-legacy focus-visible:ring-offset-2 rounded-sm"
          >
            홈으로 돌아가기
          </Link>
        </div>
