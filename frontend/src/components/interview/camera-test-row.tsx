...
export const CameraTestRow = ({ status, videoRef, onCameraTest }: CameraTestRowProps) => {
  return (
    <div className={`flex items-center gap-5 rounded-2xl border bg-card p-5 transition-colors ${statusBorder(status)}`}>
      <div className="relative h-20 w-32 shrink-0 overflow-hidden rounded-2xl bg-interview-stage">
        <video
        ...
        />
        {status !== 'passed' && (
          <div className="absolute inset-0 flex items-center justify-center bg-interview-stage/80">
