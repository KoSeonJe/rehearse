    ...
    <Dialog open={showLoginModal} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="w-full max-w-sm rounded-[28px] bg-white p-8 shadow-toss-lg border-none">
        ...
        <DialogHeader className="mb-7">
          <DialogTitle className="text-center text-lg font-extrabold tracking-tight text-text-primary">
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-2xl bg-[#24292e] px-5 py-3.5 text-[13px] font-bold text-white active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-legacy focus-visible:ring-offset-2"
          >
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-2xl border border-border bg-white px-5 py-3.5 text-[13px] font-bold text-text-primary hover:bg-surface active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-legacy focus-visible:ring-offset-2"
          >
