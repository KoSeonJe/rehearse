      ...
      <div className="relative w-full max-w-sm rounded-[28px] bg-white p-8 shadow-toss-lg animate-fade-in">
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-2xl bg-[#24292e] px-5 py-3.5 text-[13px] font-bold text-white transition-all active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-legacy focus-visible:ring-offset-2"
          >
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-2xl border border-border bg-white px-5 py-3.5 text-[13px] font-bold text-text-primary transition-all hover:bg-surface active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-legacy focus-visible:ring-offset-2"
          >
