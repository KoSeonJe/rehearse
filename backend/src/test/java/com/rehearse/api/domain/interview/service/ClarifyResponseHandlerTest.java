...
@DisplayName("ClarifyResponseHandler - Generator 위임")
class ClarifyResponseHandlerTest {
    ...
    @Test
    @DisplayName("supports()는 IntentType.CLARIFY_REQUEST를 반환한다")
    ...
    void handle_delegatesToGenerator() {
        FollowUpResponse expected = FollowUpResponse.builder()
                .type("CLARIFY_REESTABLISH").skip(true).presentToUser(true).build();
