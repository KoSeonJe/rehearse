...
@DisplayName("ClarifyResponseGenerator - CLARIFY_REQUEST LLM 응답 생성")
class ClarifyResponseGeneratorTest {
    ...
    private ClarifyResponseGenerator generator;
    ...
    @BeforeEach
    void setUp() {
        generator = new ClarifyResponseGenerator(aiClient, aiResponseParser, contextBuilder, runtimeStateCache);
    ...
    void generate_mapsAiResponseToFollowUpResponse() {
        given(aiResponseParser.parseOrRetry(any(), any(), any(), any()))
                .willReturn(new ClarifyResponseGenerator.ClarifyAiResponse(
    ...
    void generate_skipFieldsAreSet() {
        given(aiResponseParser.parseOrRetry(any(), any(), any(), any()))
                .willReturn(new ClarifyResponseGenerator.ClarifyAiResponse("질문 재설명", "질문 재설명", "재설명 이유"));
    ...
    void generate_answerTextIsPreserved() {
        given(aiResponseParser.parseOrRetry(any(), any(), any(), any()))
                .willReturn(new ClarifyResponseGenerator.ClarifyAiResponse("재설명", "재설명", "이유"));
    ...
    void generate_contextBuilder_invokedWithClarifyCallType() {
        given(aiResponseParser.parseOrRetry(any(), any(), any(), any()))
                .willReturn(new ClarifyResponseGenerator.ClarifyAiResponse("재설명", "재설명", "이유"));
