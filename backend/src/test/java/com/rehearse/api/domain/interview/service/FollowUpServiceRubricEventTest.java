...
class FollowUpServiceRubricEventTest {
    ...
    @Mock private InterviewRuntimeStateStore runtimeStateStore;
    @Mock private AiCallMetrics aiCallMetrics;
    @Mock private ResumeInterviewOrchestrator resumeOrchestrator;
    @Mock private ResumeSkeletonStore resumeSkeletonStore;
    @Mock private InterviewPlanStore interviewPlanStore;
    @Mock private ResumeSkeletonCache resumeSkeletonCache;
    @Mock private InterviewPlanCache interviewPlanCache;
