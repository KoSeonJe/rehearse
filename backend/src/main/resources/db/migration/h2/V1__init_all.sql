...
CREATE TABLE question (
    ...
    feedback_perspective VARCHAR(20),
    order_index     INT NOT NULL,
...
CREATE TABLE timestamp_feedback (
    ...
    eye_contact_level       VARCHAR(20),
    posture_level           VARCHAR(20),
    ...
    tone_confidence_level   VARCHAR(20),
    emotion_label           VARCHAR(20),
    vocal_comment           TEXT,
    accuracy_issues         TEXT,
    coaching_structure      VARCHAR(500),
    coaching_improvement    VARCHAR(500),
