...
('JUNIOR:BEHAVIORAL', '팀 프로젝트에서 기술적 의견 충돌이 있었던 경험과 해결 과정을 설명해주세요.', '협업',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '코드 리뷰에서 본인의 코드에 대해 강한 피드백을 받은 경험이 있나요? 어떻게 대처했나요?', '협업',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '처음 만나는 팀원과 프로젝트를 시작하면서 신뢰를 쌓은 경험을 이야기해주세요.', '협업',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '다른 직군(기획자, 디자이너 등)과 협업하면서 가장 어려웠던 점과 극복 방법은 무엇인가요?', '협업',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '팀원이 본인의 의견에 반대했을 때, 어떻게 대응하고 해결했나요?', '협업',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '원격(비대면) 환경에서 팀원과 효과적으로 소통했던 경험을 설명해주세요.', '협업',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '예상치 못한 기술적 문제가 발생했을 때 어떻게 대응했나요?', '문제해결',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '오랫동안 원인을 찾지 못했던 어려운 버그를 결국 수정한 경험이 있나요?', '문제해결',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '프로젝트 일정이 촉박해졌을 때 어떻게 대처했나요?', '문제해결',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '기술적 선택(라이브러리, 프레임워크 등)을 잘못했다고 느낀 경험이 있나요? 어떻게 극복했나요?', '문제해결',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '문서가 거의 없는 레거시 코드를 분석하고 이해한 경험이 있나요?', '문제해결',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '요구사항이 중간에 크게 변경된 상황에서 어떻게 대응했나요?', '문제해결',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '새로운 언어나 프레임워크를 처음 학습해서 실무에 적용한 경험을 이야기해주세요.', '성장',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '본인의 기술적 약점을 인식하고 개선한 경험을 설명해주세요.', '성장',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '프로젝트 회고에서 본인이 가장 크게 배운 점은 무엇인가요?', '성장',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '학습 중 슬럼프나 장벽을 경험했을 때 어떻게 극복했나요?', '성장',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '기술 블로그 작성이나 발표 등 지식 공유 활동을 한 경험이 있나요?', '성장',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '사이드 프로젝트나 오픈소스 기여 등 자기 주도 학습 경험에 대해 설명해주세요.', '성장',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '팀 내에서 아무도 맡지 않으려 하는 역할을 자원한 경험이 있나요?', '리더십',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '팀 내에서 지식을 공유하거나 스터디를 주도한 경험이 있나요?', '리더십',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '팀의 개발 프로세스나 컨벤션을 개선하자고 제안한 경험이 있나요?', '리더십',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '신규 팀원이나 후배의 온보딩을 도운 경험이 있나요?', '리더십',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '팀이 방향을 잃거나 진행이 정체됐을 때 주도적으로 해결한 경험이 있나요?', '리더십',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '기술 부채를 팀에 알리고 개선을 이끈 경험이 있나요?', '리더십',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '복잡한 기술적 내용을 비개발자에게 설명해야 했던 경험이 있나요?', '커뮤니케이션',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '코드 리뷰 의견에 동의하지 않을 때 어떻게 이의를 제기했나요?', '커뮤니케이션',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '새로운 아이디어를 팀에 제안하고 설득한 경험을 이야기해주세요.', '커뮤니케이션',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '기술 문서(API 문서, 설계 문서 등)를 작성하고 팀에 도움이 된 경험이 있나요?', '커뮤니케이션',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '회의를 진행하거나 팀 논의를 이끈 경험이 있나요?', '커뮤니케이션',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('JUNIOR:BEHAVIORAL', '팀원에게 건설적인 피드백을 전달해야 했던 경험이 있나요?', '커뮤니케이션',
