...
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Boot와 Spring Framework의 차이점은 무엇인가요?', 'SPRING_BOOT',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', '@SpringBootApplication 어노테이션은 어떤 역할을 하나요?', 'SPRING_BOOT',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'IoC(Inversion of Control)와 DI(Dependency Injection)의 개념을 설명해주세요.', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Bean의 생명주기를 설명해주세요.', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', '@Autowired와 생성자 주입의 차이점은 무엇이며, 생성자 주입이 권장되는 이유는 무엇인가요?', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Boot Auto Configuration은 어떻게 동작하나요?', 'SPRING_BOOT',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', '@Configuration과 @Component의 차이점은 무엇인가요?', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Boot의 내장 톰캣(Embedded Tomcat)은 무엇이며 왜 사용하나요?', 'SPRING_BOOT',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Boot Starter란 무엇인가요?', 'SPRING_BOOT',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', '@RequestMapping 어노테이션의 역할과 사용법을 설명해주세요.', 'SPRING_MVC',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', '@RestController와 @Controller의 차이점은 무엇인가요?', 'SPRING_MVC',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', '@ResponseBody 어노테이션은 어떤 역할을 하나요?', 'SPRING_MVC',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'DispatcherServlet의 역할과 Spring MVC 요청 처리 흐름을 설명해주세요.', 'SPRING_MVC',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', '@PathVariable과 @RequestParam의 차이점은 무엇인가요?', 'SPRING_MVC',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', '@Valid 어노테이션을 이용한 입력 검증은 어떻게 동작하나요?', 'SPRING_MVC',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', '@ExceptionHandler와 @ControllerAdvice를 이용한 전역 예외 처리를 설명해주세요.', 'SPRING_MVC',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring 프로파일(Profile)이란 무엇이며 어떻게 활용하나요?', 'SPRING_BOOT',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Lombok이란 무엇이며 주요 어노테이션을 설명해주세요.', 'SPRING_BOOT',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'HTTP 상태 코드 200, 201, 400, 401, 403, 404, 500의 의미를 설명해주세요.', 'SPRING_MVC',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'JPA에서 Entity 클래스를 설계할 때 주의해야 할 점은 무엇인가요?', 'JPA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Data JPA의 JpaRepository가 제공하는 기본 메서드들은 무엇인가요?', 'JPA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'REST API에서 GET과 POST의 차이점은 무엇인가요?', 'SPRING_MVC',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', '@Service, @Repository, @Controller 어노테이션의 차이는 무엇인가요?', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'application.yml에서 환경변수를 어떻게 주입하나요?', 'SPRING_BOOT',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring에서 @Transactional 어노테이션의 기본적인 역할은 무엇인가요?', 'SPRING_DATA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'DTO(Data Transfer Object)를 사용하는 이유는 무엇인가요?', 'SPRING_MVC',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring에서 Bean을 등록하는 방법은 어떤 것들이 있나요?', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'ResponseEntity를 반환하는 이유는 무엇인가요?', 'SPRING_MVC',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring MVC에서 JSON 직렬화/역직렬화는 어떻게 이루어지나요?', 'SPRING_MVC',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Java의 Optional 클래스는 무엇이며 Spring 개발에서 어떻게 활용하나요?', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Boot 프로젝트에서 패키지 구조를 어떻게 설계하는 것이 좋은가요?', 'SPRING_BOOT',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:JUNIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Flyway나 Liquibase 같은 DB 마이그레이션 도구를 사용하는 이유는 무엇인가요?', 'SPRING_DATA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Bean의 싱글톤 스코프와 멀티스레드 환경에서의 주의점을 설명해주세요.', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'AOP(Aspect-Oriented Programming)의 원리와 Spring AOP에서의 동작 방식을 설명해주세요.', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', '@Transactional이 프록시 방식으로 동작하는 것의 의미와 주의사항은 무엇인가요?', 'SPRING_DATA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring @Transactional의 전파 레벨(Propagation) 종류와 차이점을 설명해주세요.', 'SPRING_DATA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Security에서 인증(Authentication)과 인가(Authorization)의 차이를 설명해주세요.', 'SPRING_SECURITY',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Security의 Filter와 Spring Interceptor의 차이점은 무엇인가요?', 'SPRING_SECURITY',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'JWT 기반 인증에서 Access Token과 Refresh Token의 역할과 보안 고려사항은?', 'SPRING_SECURITY',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'JPA N+1 문제란 무엇이며 어떻게 해결하나요?', 'JPA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'JPA의 Lazy Loading과 Eager Loading의 차이와 권장 설정은 무엇인가요?', 'JPA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring에서 순환 참조(Circular Dependency) 문제는 왜 발생하며 어떻게 해결하나요?', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'QueryDSL을 사용하는 이유와 장점은 무엇인가요?', 'JPA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring의 이벤트(ApplicationEvent) 메커니즘을 설명해주세요.', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Cache 추상화(@Cacheable)와 활용 방법을 설명해주세요.', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Security의 SecurityFilterChain 설정 방법을 설명해주세요.', 'SPRING_SECURITY',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring의 @Async 어노테이션 동작 방식과 주의사항을 설명해주세요.', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'JPA의 더티 체킹(Dirty Checking) 메커니즘을 설명해주세요.', 'JPA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring의 RestTemplate과 WebClient의 차이점은 무엇인가요?', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'JPA의 @OneToMany 매핑에서 양방향 연관관계 설정 시 주의사항은 무엇인가요?', 'JPA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Boot Actuator의 역할과 주요 엔드포인트를 설명해주세요.', 'SPRING_BOOT',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring의 @Scheduled를 이용한 스케줄링 작업 설정 방법은?', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring의 CORS(Cross-Origin Resource Sharing) 설정 방법을 설명해주세요.', 'SPRING_MVC',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'JPA 영속성 컨텍스트의 1차 캐시 동작을 설명해주세요.', 'JPA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring에서 파일 업로드 처리 방식과 멀티파트 설정을 설명해주세요.', 'SPRING_MVC',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring에서 페이지네이션을 구현하는 방법을 설명해주세요.', 'SPRING_DATA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring의 의존성 주입에서 @Primary와 @Qualifier의 역할은?', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'JPA에서 벌크 업데이트(@Modifying) 사용 시 주의사항은 무엇인가요?', 'JPA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring의 MessageSource를 이용한 다국어(i18n) 처리를 설명해주세요.', 'SPRING_MVC',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Data JPA에서 Projection을 사용하는 이유와 방법은?', 'JPA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:MID:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring에서 테스트 슬라이스 어노테이션(@WebMvcTest, @DataJpaTest)의 역할은?', 'SPRING_BOOT',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'BeanFactory와 ApplicationContext의 차이점과 ApplicationContext의 부가 기능을 설명해주세요.', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'CGLIB Proxy와 JDK Dynamic Proxy의 차이점과 Spring Boot 3.x의 기본 설정은?', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', '@Transactional이 private 메서드에 동작하지 않는 이유와 대안을 설명해주세요.', 'SPRING_DATA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Boot Auto Configuration의 조건부 Bean 등록 메커니즘을 상세히 설명해주세요.', 'SPRING_BOOT',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring에서 Event-Driven Architecture를 구현할 때 트랜잭션 경계 문제를 어떻게 해결하나요?', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'JPA Cascade와 OrphanRemoval의 차이와 적절한 사용 시나리오를 설명해주세요.', 'JPA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Boot 애플리케이션의 대규모 배치 처리를 Spring Batch로 설계할 때 고려사항은?', 'SPRING_BOOT',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring에서 Optimistic Lock과 Pessimistic Lock의 차이와 적용 시나리오는?', 'JPA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring WebFlux와 Spring MVC의 차이점 및 선택 기준은?', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Boot 애플리케이션의 메모리 튜닝과 GC 설정 전략은?', 'SPRING_BOOT',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring에서 멀티 모듈 프로젝트를 구성할 때의 장점과 의존성 설계 원칙은?', 'SPRING_BOOT',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring에서 분산 트랜잭션(SAGA 패턴)이 필요한 상황과 구현 방법은?', 'SPRING_DATA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'JPA의 2차 캐시(Second Level Cache) 동작 방식과 적용 전략은?', 'JPA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Cloud Gateway와 API Gateway 패턴의 역할을 설명해주세요.', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring 애플리케이션에서 메시지 큐(Kafka/RabbitMQ)를 활용한 비동기 처리 설계를 설명해주세요.', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Security OAuth2 Resource Server와 Authorization Server의 차이를 설명해주세요.', 'SPRING_SECURITY',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Resilience4j를 활용한 Circuit Breaker 패턴 구현 방법을 설명해주세요.', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Batch에서 Partitioning과 Multi-Threading의 차이와 사용 시나리오는?', 'SPRING_BOOT',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Domain-Driven Design(DDD)을 Spring Boot 프로젝트에 적용하는 방법은?', 'SPRING_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Spring Boot 애플리케이션의 성능 프로파일링과 병목 분석 방법은?', 'SPRING_BOOT',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('BACKEND:SENIOR:JAVA_SPRING:LANGUAGE_FRAMEWORK', 'Java 21 Virtual Thread와 Spring Boot 3.2+의 통합 방법 및 한계점은?', 'SPRING_BOOT',
