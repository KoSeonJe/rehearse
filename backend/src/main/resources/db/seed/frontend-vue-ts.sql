...
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 2와 Vue 3의 주요 차이점은 무엇인가요?', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue의 반응성 시스템(Reactivity System)이란 무엇인가요?', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Options API와 Composition API의 차이점을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'ref와 reactive의 차이점은 무엇인가요?', 'COMPOSITION_API',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'computed와 watch의 차이점과 각각의 사용 시점을 설명해주세요.', 'COMPOSITION_API',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'v-model 디렉티브의 동작 원리를 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 컴포넌트의 라이프사이클 훅을 순서대로 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Props와 Emit을 사용한 부모-자식 컴포넌트 통신 방법을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 Slot의 역할과 사용법을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Pinia와 Vuex의 차이점은 무엇인가요?', 'PINIA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Pinia에서 store를 정의하고 사용하는 기본 방법을 설명해주세요.', 'PINIA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue Router의 기본 개념과 설정 방법을 설명해주세요.', 'ROUTING',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue Router의 동적 라우팅(Dynamic Route)이란 무엇인가요?', 'ROUTING',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue Router의 Navigation Guard란 무엇이며 어떻게 사용하나요?', 'ROUTING',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'v-if와 v-show의 차이점을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 key 속성은 왜 중요한가요?', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'TypeScript에서 ref()를 사용할 때 타입을 지정하는 방법을 설명해주세요.', 'COMPOSITION_API',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 Template Ref로 DOM 요소에 직접 접근하는 방법을 설명해주세요.', 'COMPOSITION_API',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Pinia store에서 getter를 정의하고 사용하는 방법을 설명해주세요.', 'PINIA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 watchEffect와 watch의 차이점을 설명해주세요.', 'COMPOSITION_API',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 컴포넌트에서 async/await를 사용하는 방법을 설명해주세요.', 'COMPOSITION_API',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 전역 컴포넌트와 지역 컴포넌트의 차이점을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 v-for 디렉티브 사용 시 주의사항을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 커스텀 디렉티브(Custom Directive)란 무엇인가요?', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 Plugin이란 무엇이며 어떻게 만드나요?', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'TypeScript에서 interface와 type의 차이점을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Pinia에서 action을 통해 비동기 처리를 하는 방법을 설명해주세요.', 'PINIA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:JUNIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 Transition 컴포넌트를 사용하는 방법을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Composition API를 활용한 Composable(커스텀 훅) 작성 방법과 장점을 설명해주세요.', 'COMPOSITION_API',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Provide/Inject 패턴의 동작 원리와 사용 시점을 설명해주세요.', 'COMPOSITION_API',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 템플릿 컴파일 과정을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'readonly()와 shallowRef()의 사용 목적을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Pinia에서 store를 모듈화하여 설계하는 전략을 설명해주세요.', 'PINIA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 Teleport 컴포넌트의 역할과 사용 사례를 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'v-if와 v-show 성능 차이를 실제 시나리오로 설명해주세요.', 'PERFORMANCE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'TypeScript로 Pinia store를 타입 안전하게 설계하는 방법을 설명해주세요.', 'PINIA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 컴포넌트에서 메모이제이션을 활용한 성능 최적화 방법을 설명해주세요.', 'PERFORMANCE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 Error Boundary를 구현하는 방법을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 Suspense 컴포넌트의 역할과 사용 방법을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 Virtual DOM의 diffing 알고리즘을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 3에서 Render Function과 JSX를 사용하는 방법을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 컴포넌트 테스트(Unit Test)를 작성하는 방법을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 프로젝트에서 환경변수를 관리하는 방법을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 컴포넌트 간 상태 동기화를 위한 전략을 설명해주세요.', 'PINIA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue Router의 Scroll Behavior를 커스터마이즈하는 방법을 설명해주세요.', 'ROUTING',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Pinia에서 Plugin을 만드는 방법과 사용 사례를 설명해주세요.', 'PINIA',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 접근성(a11y)을 고려한 컴포넌트 개발 방법을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 국제화(i18n)를 구현하는 방법을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 코드 스플리팅(Code Splitting)을 구현하는 전략을 설명해주세요.', 'PERFORMANCE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 Form Validation을 처리하는 방법을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue Router에서 Meta 필드를 활용한 라우트 권한 처리를 설명해주세요.', 'ROUTING',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 CSS 모듈과 Scoped CSS의 차이점을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 프로젝트에서 ESLint와 Prettier를 설정하는 방법을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 대용량 리스트 렌더링을 최적화하는 방법을 설명해주세요.', 'PERFORMANCE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 emit 타입을 TypeScript로 정의하는 고급 방법을 설명해주세요.', 'COMPOSITION_API',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:MID:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue Router에서 Programmatic Navigation의 고급 패턴을 설명해주세요.', 'ROUTING',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 3 반응성 프록시의 내부 동작과 한계점을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', '복잡한 Composition API Composable을 재사용 가능하게 설계하는 원칙을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vite의 HMR(Hot Module Replacement) 동작 원리를 설명해주세요.', 'PERFORMANCE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'defineAsyncComponent()를 활용한 고급 비동기 컴포넌트 패턴을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Nuxt 3의 Server Components와 Universal Rendering을 설명해주세요.', 'ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 3의 Custom Renderer API를 설명하고 사용 사례를 제시해주세요.', 'ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 프로젝트의 마이크로 프론트엔드 아키텍처 구현 방법을 설명해주세요.', 'ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 애플리케이션의 성능 측정과 최적화 워크플로우를 설명해주세요.', 'PERFORMANCE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue TypeScript 프로젝트의 타입 안전성을 극대화하는 고급 패턴을 설명해주세요.', 'ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 프로젝트에서 상태 관리 아키텍처 선택 기준을 설명해주세요.', 'ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 컴포넌트 라이브러리를 만들 때 고려해야 할 사항을 설명해주세요.', 'ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 3의 effectScope() API를 설명하고 고급 사용 사례를 제시해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 앱의 SSR(Server-Side Rendering) 구현 시 주의사항을 설명해주세요.', 'ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 프로젝트의 CI/CD 파이프라인과 테스트 전략을 설명해주세요.', 'ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue Router의 Advanced Patterns(중첩 라우트, Parallel Views)를 설명해주세요.', 'ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 프로젝트에서 WebSocket 실시간 통신을 구현하는 아키텍처를 설명해주세요.', 'ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 앱의 번들 분석과 성능 예산(Performance Budget) 관리 방법을 설명해주세요.', 'PERFORMANCE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', '대규모 Vue 프로젝트의 폴더 구조와 아키텍처 설계 원칙을 설명해주세요.', 'ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 프로젝트에서 디자인 시스템과 컴포넌트 라이브러리를 통합하는 전략을 설명해주세요.', 'ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 앱에서 메모리 누수를 방지하는 방법을 설명해주세요.', 'PERFORMANCE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 3의 @vue/reactivity 패키지를 프레임워크 외부에서 독립적으로 사용하는 방법을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 앱의 보안(XSS, CSRF) 처리 방법을 설명해주세요.', 'ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 앱의 오프라인 지원과 PWA 구현 전략을 설명해주세요.', 'ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 프로젝트에서 모노레포(Monorepo) 구성과 패키지 공유 전략을 설명해주세요.', 'ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 앱에서 상태 변화의 Undo/Redo 기능을 구현하는 아키텍처를 설명해주세요.', 'ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', '주니어 Vue 개발자에게 코드 리뷰 시 가장 자주 피드백하는 패턴과 개선 방법을 설명해주세요.', 'ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue에서 nextTick의 내부 동작과 고급 활용 패턴을 설명해주세요.', 'VUE_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 3의 Vapor Mode(컴파일 최적화)에 대해 설명해주세요.', 'PERFORMANCE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('FRONTEND:SENIOR:VUE_TS:LANGUAGE_FRAMEWORK', 'Vue 앱에서 국제화(i18n)와 지역화(l10n)를 확장 가능하게 아키텍처링하는 방법을 설명해주세요.', 'ARCHITECTURE',
