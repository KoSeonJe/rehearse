...
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 GIL(Global Interpreter Lock)이란 무엇인가요?', '파이썬의 길(글로벌 인터프리터 락)이란 무엇인가요?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python 데코레이터(Decorator)의 기본 개념과 사용법을 설명해주세요.', '파이썬 데코레이터(데코레이터)의 기본 개념과 사용법을 설명해주세요.', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django와 FastAPI의 주요 차이점은 무엇인가요?', '장고와 패스트에이피아이의 주요 차이점은 무엇인가요?', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django의 MTV 아키텍처를 설명해주세요.', '장고의 엠티브이 아키텍처를 설명해주세요.', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 async/await 기본 문법과 동작 방식을 설명해주세요.', '파이썬의 에이싱크 어웨이트 기본 문법과 동작 방식을 설명해주세요.', 'ASYNC',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 @property 데코레이터 사용법과 이점은?', '파이썬의 앳 프로퍼티 데코레이터 사용법과 이점은?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django ORM의 기본 사용법과 QuerySet이란 무엇인가요?', '장고 오알엠의 기본 사용법과 쿼리셋이란 무엇인가요?', 'ORM',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'FastAPI에서 의존성 주입(Dependency Injection)을 어떻게 구현하나요?', '패스트에이피아이에서 의존성 주입(디펜던시 인젝션)을 어떻게 구현하나요?', 'FASTAPI',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 리스트 컴프리헨션과 제너레이터 표현식의 차이는 무엇인가요?', '파이썬의 리스트 컴프리헨션과 제너레이터 표현식의 차이는 무엇인가요?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python 제너레이터(Generator)란 무엇이며 어떻게 사용하나요?', '파이썬 제너레이터(제너레이터)란 무엇이며 어떻게 사용하나요?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django에서 URL 패턴을 설정하는 방법을 설명해주세요.', '장고에서 유알엘 패턴을 설정하는 방법을 설명해주세요.', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django REST Framework(DRF)의 Serializer 역할은 무엇인가요?', '장고 레스트 프레임워크(디알에프)의 시리얼라이저 역할은 무엇인가요?', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'FastAPI에서 Pydantic 모델을 이용한 요청/응답 검증을 설명해주세요.', '패스트에이피아이에서 파이댄틱 모델을 이용한 요청/응답 검증을 설명해주세요.', 'FASTAPI',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 *args와 **kwargs는 무엇인가요?', '파이썬의 *args와 **kwargs는 무엇인가요?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django에서 마이그레이션(Migration)이란 무엇이며 어떻게 관리하나요?', '장고에서 마이그레이션(마이그레이션)이란 무엇이며 어떻게 관리하나요?', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 클래스와 인스턴스 변수의 차이점은?', '파이썬의 클래스와 인스턴스 변수의 차이점은?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django의 settings.py에서 환경별 설정을 어떻게 분리하나요?', '장고의 세팅스.파이에서 환경별 설정을 어떻게 분리하나요?', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'FastAPI의 경로 파라미터, 쿼리 파라미터, 요청 바디 처리 방법을 설명해주세요.', '패스트에이피아이의 경로 파라미터, 쿼리 파라미터, 요청 바디 처리 방법을 설명해주세요.', 'FASTAPI',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 예외 처리(try/except/finally)를 설명해주세요.', '파이썬의 예외 처리(try/except/finally)를 설명해주세요.', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django의 Admin 인터페이스를 어떻게 설정하고 활용하나요?', '장고의 어드민 인터페이스를 어떻게 설정하고 활용하나요?', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 딕셔너리 컴프리헨션과 집합 컴프리헨션을 설명해주세요.', '파이썬의 딕셔너리 컴프리헨션과 집합 컴프리헨션을 설명해주세요.', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django의 모델 관계(ForeignKey, ManyToMany)를 설명해주세요.', '장고의 모델 관계(포린키, 메니투메니)를 설명해주세요.', 'ORM',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 with 문(Context Manager)은 어떻게 동작하나요?', '파이썬의 with 문(컨텍스트 매니저)은 어떻게 동작하나요?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'FastAPI에서 HTTP 예외 처리를 어떻게 구현하나요?', '패스트에이피아이에서 에이치티티피 예외 처리를 어떻게 구현하나요?', 'FASTAPI',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 타입 힌트(Type Hints)란 무엇이며 왜 사용하나요?', '파이썬의 타입 힌트(타입 힌츠)란 무엇이며 왜 사용하나요?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django에서 정적 파일(static files)과 미디어 파일(media files)의 차이는?', '장고에서 정적 파일(스태틱 파일스)과 미디어 파일(미디어 파일스)의 차이는?', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'FastAPI에서 CORS 설정 방법을 설명해주세요.', '패스트에이피아이에서 코어스 설정 방법을 설명해주세요.', 'FASTAPI',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python 가상 환경(venv, virtualenv)을 사용하는 이유는?', '파이썬 가상 환경(브이엔브이, 버츄얼엔브이)을 사용하는 이유는?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django의 signals 기본 개념을 설명해주세요.', '장고의 시그널스 기본 개념을 설명해주세요.', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 람다(lambda) 함수와 일반 함수의 차이는?', '파이썬의 람다(람다) 함수와 일반 함수의 차이는?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:JUNIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django에서 인증과 세션 관리는 어떻게 이루어지나요?', '장고에서 인증과 세션 관리는 어떻게 이루어지나요?', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 GIL을 우회하는 방법과 멀티프로세싱 접근 방법을 설명해주세요.', '파이썬의 길을 우회하는 방법과 멀티프로세싱 접근 방법을 설명해주세요.', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', '파라미터를 받는 데코레이터(Parameterized Decorator)를 어떻게 구현하나요?', '파라미터를 받는 데코레이터(Parameterized 데코레이터)를 어떻게 구현하나요?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django Middleware의 동작 방식과 커스텀 미들웨어 작성 방법을 설명해주세요.', '장고 미들웨어의 동작 방식과 커스텀 미들웨어 작성 방법을 설명해주세요.', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django ORM의 QuerySet Lazy Evaluation과 평가 시점을 상세히 설명해주세요.', '장고 오알엠의 쿼리셋 레이지 에밸류에이션과 평가 시점을 상세히 설명해주세요.', 'ORM',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django의 select_related와 prefetch_related의 차이와 사용 시나리오는?', '장고의 셀렉트 릴레이티드와 프리페치 릴레이티드의 차이와 사용 시나리오는?', 'ORM',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django의 Signal 패턴과 실제 서비스에서의 트레이드오프를 설명해주세요.', '장고의 시그널 패턴과 실제 서비스에서의 트레이드오프를 설명해주세요.', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'FastAPI의 BackgroundTasks와 Celery의 차이와 선택 기준은?', '패스트에이피아이의 백그라운드태스크스와 셀러리의 차이와 선택 기준은?', 'FASTAPI',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 동시성과 병렬성의 차이를 설명하고, 각 모듈을 비교해주세요.', '파이썬의 동시성과 병렬성의 차이를 설명하고, 각 모듈을 비교해주세요.', 'ASYNC',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Pydantic v2의 주요 변경사항과 모델 유효성 검증 방법을 설명해주세요.', '파이댄틱 v2의 주요 변경사항과 모델 유효성 검증 방법을 설명해주세요.', 'FASTAPI',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django에서 커스텀 Manager를 사용하는 이유와 방법은?', '장고에서 커스텀 매니저를 사용하는 이유와 방법은?', 'ORM',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 메타클래스(Metaclass)란 무엇이며 어떻게 활용되나요?', '파이썬의 메타클래스(메타클래스)란 무엇이며 어떻게 활용되나요?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'FastAPI에서 OAuth2 + JWT 인증을 구현하는 방법을 설명해주세요.', '패스트에이피아이에서 오오쓰 투 + 제이더블유티 인증을 구현하는 방법을 설명해주세요.', 'FASTAPI',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django에서 캐싱 전략과 Redis 활용 방법을 설명해주세요.', '장고에서 캐싱 전략과 레디스 활용 방법을 설명해주세요.', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python에서 소프트 삭제(Soft Delete) 패턴을 구현하는 방법은?', '파이썬에서 소프트 삭제(소프트 딜리트) 패턴을 구현하는 방법은?', 'ORM',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 asyncio.gather와 asyncio.create_task의 차이를 설명해주세요.', '파이썬의 에이싱크아이오 개더와 에이싱크아이오 크리에이트 태스크의 차이를 설명해주세요.', 'ASYNC',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django의 커스텀 User 모델을 설계할 때 고려사항은 무엇인가요?', '장고의 커스텀 유저 모델을 설계할 때 고려사항은 무엇인가요?', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 데이터클래스(dataclass)와 Pydantic 모델의 차이점은?', '파이썬의 데이터클래스(데이터클래스)와 파이댄틱 모델의 차이점은?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'FastAPI에서 WebSocket을 구현하는 방법을 설명해주세요.', '패스트에이피아이에서 웹소켓을 구현하는 방법을 설명해주세요.', 'FASTAPI',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django의 F() 표현식과 Q() 표현식을 언제 사용하나요?', '장고의 에프 표현식과 큐 표현식을 언제 사용하나요?', 'ORM',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 메모리 관리와 참조 카운팅(Reference Counting) 방식을 설명해주세요.', '파이썬의 메모리 관리와 참조 카운팅(레퍼런스 카운팅) 방식을 설명해주세요.', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django에서 트랜잭션 처리 방법을 설명해주세요.', '장고에서 트랜잭션 처리 방법을 설명해주세요.', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'asyncio 이벤트 루프의 내부 동작 원리를 설명해주세요.', '에이싱크아이오 이벤트 루프의 내부 동작 원리를 설명해주세요.', 'ASYNC',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python 3.13 Free-Threading(GIL 없는 CPython) 실험적 기능과 영향은?', '파이썬 3.13 프리 스레딩(길 없는 C파이썬) 실험적 기능과 영향은?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django에서 대규모 데이터셋의 쿼리를 최적화하는 고급 기법을 설명해주세요.', '장고에서 대규모 데이터셋의 쿼리를 최적화하는 고급 기법을 설명해주세요.', 'ORM',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'FastAPI 기반 마이크로서비스 아키텍처 설계 시 고려사항은?', '패스트에이피아이 기반 마이크로서비스 아키텍처 설계 시 고려사항은?', 'FASTAPI',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python에서 Protocol과 ABC(Abstract Base Class)의 차이와 사용 시나리오는?', '파이썬에서 프로토콜과 에이비씨(추상 베이스 클래스)의 차이와 사용 시나리오는?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Celery의 작업 실패 처리, 재시도, 멱등성 설계 방법은?', '셀러리의 작업 실패 처리, 재시도, 멱등성 설계 방법은?', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django에서 멀티 테넌시(Multi-Tenancy) 아키텍처를 구현하는 방법은?', '장고에서 멀티 테넌시(멀티 테넌시) 아키텍처를 구현하는 방법은?', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 디스크립터(Descriptor) 프로토콜을 설명해주세요.', '파이썬의 디스크립터(디스크립터) 프로토콜을 설명해주세요.', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'FastAPI와 SQLAlchemy 2.0 async ORM을 통합할 때의 패턴과 세션 관리 방법은?', '패스트에이피아이와 에스큐엘 알케미 2.0 에이싱크 오알엠을 통합할 때의 패턴과 세션 관리 방법은?', 'FASTAPI',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python 기반 고성능 API 서버의 배포 스택 최적화 방법은?', '파이썬 기반 고성능 에이피아이 서버의 배포 스택 최적화 방법은?', 'FASTAPI',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python에서 이벤트 소싱(Event Sourcing) 패턴을 구현하는 방법은?', '파이썬에서 이벤트 소싱(이벤트 소싱) 패턴을 구현하는 방법은?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django REST Framework에서 커스텀 Serializer 검증 로직을 구현하는 방법은?', '장고 레스트 프레임워크에서 커스텀 시리얼라이저 검증 로직을 구현하는 방법은?', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 asyncio에서 Task와 gather, wait의 차이점을 설명해주세요.', '파이썬의 에이싱크아이오에서 Task와 gather, wait의 차이점을 설명해주세요.', 'ASYNC',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'FastAPI의 Dependency Injection 시스템을 심층적으로 설명해주세요.', '패스트에이피아이의 의존성 주입 시스템을 심층적으로 설명해주세요.', 'FASTAPI',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django의 signals(신호)는 무엇이며 언제 사용해야 하나요?', '장고의 signals(신호)는 무엇이며 언제 사용해야 하나요?', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python에서 컨텍스트 매니저(Context Manager)를 직접 구현하는 방법은?', '파이썬에서 컨텍스트 매니저(컨텍스트 매니저)를 직접 구현하는 방법은?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django의 ORM에서 select_related와 prefetch_related의 차이와 사용 시나리오는?', '장고의 오알엠에서 셀렉트 릴레이티드와 프리페치 릴레이티드의 차이와 사용 시나리오는?', 'ORM',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Pydantic v2의 주요 변경 사항과 FastAPI에서의 활용 방법은?', '파이다틱 v2의 주요 변경 사항과 패스트에이피아이에서의 활용 방법은?', 'FASTAPI',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python에서 멀티프로세싱(multiprocessing)과 멀티스레딩(threading)의 차이와 선택 기준은?', '파이썬에서 멀티프로세싱(멀티프로세싱)과 멀티스레딩(멀티스레딩)의 차이와 선택 기준은?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:MID:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django의 미들웨어(Middleware) 동작 원리와 커스텀 미들웨어 작성 방법은?', '장고의 미들웨어(미들웨어) 동작 원리와 커스텀 미들웨어 작성 방법은?', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django에서 대규모 트래픽을 처리하기 위한 수평 확장 전략을 설명해주세요.', '장고에서 대규모 트래픽을 처리하기 위한 수평 확장 전략을 설명해주세요.', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python에서 타입 힌트와 mypy를 활용한 정적 타입 검사 전략은?', '파이썬에서 타입 힌트와 mypy를 활용한 정적 타입 검사 전략은?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'FastAPI에서 백그라운드 태스크와 Celery의 역할을 비교하고 선택 기준을 설명해주세요.', '패스트에이피아이에서 백그라운드 태스크와 셀러리의 역할을 비교하고 선택 기준을 설명해주세요.', 'FASTAPI',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 메타클래스(Metaclass)를 활용한 프레임워크 설계 패턴은?', '파이썬의 메타클래스(메타클래스)를 활용한 프레임워크 설계 패턴은?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django에서 Full-Text Search를 구현하는 방법과 ElasticSearch 연동 전략은?', '장고에서 풀텍스트 서치를 구현하는 방법과 일래스틱서치 연동 전략은?', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python에서 제너레이터와 이터레이터 프로토콜의 고급 활용 방법은?', '파이썬에서 제너레이터와 이터레이터 프로토콜의 고급 활용 방법은?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'FastAPI에서 OAuth2와 JWT를 활용한 완전한 인증/인가 시스템 설계 방법은?', '패스트에이피아이에서 오오쓰 투와 제이더블유티를 활용한 완전한 인증/인가 시스템 설계 방법은?', 'FASTAPI',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python의 __slots__를 활용한 메모리 최적화와 성능 개선 방법은?', '파이썬의 슬롯츠를 활용한 메모리 최적화와 성능 개선 방법은?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django에서 GraphQL API를 Strawberry 또는 Graphene으로 구현하는 방법은?', '장고에서 그래프큐엘 에이피아이를 스트로베리 또는 그래핀으로 구현하는 방법은?', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python 기반 서비스의 분산 추적(Distributed Tracing)과 OpenTelemetry 통합 방법은?', '파이썬 기반 서비스의 분산 추적(분산 추적)과 오픈텔레메트리 통합 방법은?', 'FASTAPI',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django의 커스텀 ORM Manager와 QuerySet으로 도메인 로직을 캡슐화하는 방법은?', '장고의 커스텀 오알엠 매니저와 쿼리셋으로 도메인 로직을 캡슐화하는 방법은?', 'ORM',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python에서 함수형 프로그래밍 기법(함수 합성, 커링, 부분 적용)의 실용적 활용은?', '파이썬에서 함수형 프로그래밍 기법(함수 합성, 커링, 부분 적용)의 실용적 활용은?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'FastAPI와 Redis를 활용한 실시간 알림 및 SSE(Server-Sent Events) 구현 방법은?', '패스트에이피아이와 레디스를 활용한 실시간 알림 및 에스에스이(서버센트 이벤츠) 구현 방법은?', 'FASTAPI',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django 프로젝트의 CI/CD 파이프라인과 자동화 테스트 전략을 설명해주세요.', '장고 프로젝트의 씨아이 씨디 파이프라인과 자동화 테스트 전략을 설명해주세요.', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python 비동기 애플리케이션에서 데이터베이스 커넥션 풀 관리 전략은?', '파이썬 비동기 애플리케이션에서 데이터베이스 커넥션 풀 관리 전략은?', 'ASYNC',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python에서 의존성 주입(Dependency Injection) 컨테이너를 구현하거나 활용하는 방법은?', '파이썬에서 의존성 주입(의존성 주입) 컨테이너를 구현하거나 활용하는 방법은?', 'PYTHON_CORE',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Django 마이그레이션 전략과 무중단 스키마 변경 방법을 설명해주세요.', '장고 마이그레이션 전략과 무중단 스키마 변경 방법을 설명해주세요.', 'DJANGO',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('BACKEND:SENIOR:PYTHON_DJANGO:LANGUAGE_FRAMEWORK', 'Python에서 성능 프로파일링과 최적화를 위한 도구와 기법을 설명해주세요.', '파이썬에서 성능 프로파일링과 최적화를 위한 도구와 기법을 설명해주세요.', 'PYTHON_CORE',
