...
('MID:BEHAVIORAL', '서로 다른 팀(백엔드/프론트엔드/디자인 등) 사이에서 발생한 갈등을 중재한 경험이 있나요?', '협업',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '주니어 개발자를 멘토링하면서 어려웠던 점과 극복 방법을 이야기해주세요.', '협업',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '외부 팀이나 벤더와 협업하면서 발생한 문제를 해결한 경험이 있나요?', '협업',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '여러 팀의 이해관계가 충돌하는 프로젝트에서 어떻게 합의를 이끌었나요?', '협업',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '팀 문화나 업무 방식을 개선하기 위해 주도적으로 행동한 경험이 있나요?', '협업',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '코드 리뷰 문화를 팀에 정착시키거나 개선한 경험이 있나요?', '협업',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '프로덕션 장애를 대응한 경험을 단계별로 설명해주세요.', '문제해결',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '기술 부채가 누적된 시스템을 점진적으로 개선한 경험이 있나요?', '문제해결',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '성능 병목을 찾아 시스템을 최적화한 경험을 구체적으로 설명해주세요.', '문제해결',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '여러 팀에 영향을 미치는 아키텍처 변경을 주도한 경험이 있나요?', '문제해결',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '데이터 마이그레이션이나 시스템 전환 중 발생한 문제를 해결한 경험이 있나요?', '문제해결',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '보안 취약점을 발견하고 대응한 경험이 있나요?', '문제해결',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '주니어에서 미드레벨로 성장하면서 가장 크게 바뀐 점은 무엇인가요?', '성장',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '기술적으로 잘못된 결정을 내렸다가 수정한 경험이 있나요?', '성장',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '도메인 지식이 부족한 상황에서 복잡한 비즈니스 요구사항을 이해하고 구현한 경험이 있나요?', '성장',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '기술 트렌드를 학습하고 실무에 적용한 판단 기준이 있나요?', '성장',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '팀 전체의 개발 생산성을 높이기 위해 기여한 경험이 있나요?', '성장',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '커리어에서 가장 어려운 결정을 내린 경험이 있나요?', '성장',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '경영진이나 PM을 설득하여 기술적 결정을 관철한 경험이 있나요?', '리더십',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '팀의 기술 방향성을 제시하거나 기술 로드맵을 수립한 경험이 있나요?', '리더십',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '팀원의 성과가 기대에 미치지 못할 때 어떻게 대처했나요?', '리더십',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '테크 리드 또는 리드 개발자로서 팀의 기술적 결정을 이끈 경험이 있나요?', '리더십',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '스프린트나 프로젝트 일정이 위기에 처했을 때 팀을 이끈 경험이 있나요?', '리더십',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '조직 내 변화(새 프로세스, 도구 도입)를 이끌면서 저항을 극복한 경험이 있나요?', '리더십',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '이해관계자(PM, 비즈니스 팀)에게 기술적 제약을 설득력 있게 전달한 경험이 있나요?', '커뮤니케이션',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '기술 부채나 아키텍처 개선의 중요성을 비개발 의사결정자에게 설명한 경험이 있나요?', '커뮤니케이션',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '팀 간 정보 사일로(silos)를 해소하기 위해 어떤 노력을 했나요?', '커뮤니케이션',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '어려운 피드백(성과 평가, 부정적 리뷰)을 팀원에게 전달한 경험이 있나요?', '커뮤니케이션',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '프로젝트 리스크를 사전에 파악하고 이해관계자에게 투명하게 공유한 경험이 있나요?', '커뮤니케이션',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('MID:BEHAVIORAL', '크로스펑셔널 팀(기획/디자인/마케팅/개발)에서 개발 입장을 효과적으로 대표한 경험이 있나요?', '커뮤니케이션',
