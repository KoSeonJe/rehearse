...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:JUNIOR:AWS_K8S:INFRA_CICD', 'Shell 스크립트의 기본 작성법과 CI 자동화에서의 활용을 설명해주세요.', 'CICD',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:JUNIOR:AWS_K8S:INFRA_CICD', 'SonarQube와 같은 코드 품질 도구를 CI에 통합하는 방법을 설명해주세요.', 'CICD',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:JUNIOR:AWS_K8S:INFRA_CICD', '컨테이너 오케스트레이션이 필요한 이유를 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:JUNIOR:AWS_K8S:INFRA_CICD', 'DevOps 문화의 핵심 원칙을 설명해주세요.', 'CICD',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:INFRA_CICD', 'K8s Namespace의 역할과 멀티테넌시 구현 방법을 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:INFRA_CICD', 'GitOps의 개념과 ArgoCD를 활용한 구현을 설명해주세요.', 'CICD',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:INFRA_CICD', 'K8s NetworkPolicy로 Pod 간 통신을 제어하는 방법을 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:INFRA_CICD', 'Prometheus와 Grafana를 활용한 K8s 모니터링 구성을 설명해주세요.', 'CICD',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:INFRA_CICD', 'Istio 서비스 메시의 핵심 기능을 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:INFRA_CICD', 'K8s RBAC(Role-Based Access Control) 설정 방법을 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:INFRA_CICD', 'Terraform state 관리와 팀 협업 방법을 설명해주세요.', 'CICD',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:INFRA_CICD', 'K8s DaemonSet과 Job, CronJob의 용도를 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:INFRA_CICD', 'EKS에서 ALB Ingress Controller를 설정하는 방법을 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:INFRA_CICD', 'Loki와 Promtail을 활용한 K8s 로그 집계를 설명해주세요.', 'CICD',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:INFRA_CICD', 'K8s에서 Secret 관리를 강화하는 방법(External Secrets, Sealed Secrets)을 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:INFRA_CICD', 'Docker 이미지 취약점 스캔(Trivy, Snyk)을 CI에 통합하는 방법을 설명해주세요.', 'DOCKER',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:INFRA_CICD', 'K8s Pod Disruption Budget(PDB)의 역할을 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:INFRA_CICD', 'Ansible을 활용한 서버 구성 관리를 설명해주세요.', 'CICD',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', 'K8s 클러스터 업그레이드 전략과 Zero-Downtime 유지 방법을 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', 'K8s Operator 패턴의 개념과 구현 방법을 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', '멀티 클러스터 K8s 관리 전략을 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', 'Chaos Engineering의 원칙과 실천 방법을 설명해주세요.', 'CICD',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', 'SRE의 SLI, SLO, SLA, Error Budget 개념을 설명해주세요.', 'CICD',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', 'K8s 보안 강화(Pod Security Standards, OPA Gatekeeper)를 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', 'OpenTelemetry를 활용한 분산 추적 시스템 구축을 설명해주세요.', 'CICD',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', 'Platform Engineering과 Internal Developer Platform(IDP) 구축을 설명해주세요.', 'CICD',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', 'K8s eBPF 기반 CNI(Cilium)의 장점을 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', 'CI/CD 파이프라인의 보안(DevSecOps)을 강화하는 방법을 설명해주세요.', 'CICD',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', 'K8s 클러스터 비용 최적화 전략을 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', 'Karpenter를 활용한 K8s 노드 자동 프로비저닝을 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', 'Progressive Delivery(피처 플래그, 카나리)를 Argo Rollouts으로 구현하는 방법을 설명해주세요.', 'CICD',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', 'K8s etcd 백업과 복구 전략을 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', 'Terraform 모듈화와 엔터프라이즈 IaC 설계를 설명해주세요.', 'CICD',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', '대규모 K8s 클러스터의 성능 튜닝을 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', 'DORA 메트릭과 DevOps 성숙도 평가 방법을 설명해주세요.', 'CICD',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', 'K8s 멀티테넌시 보안(Hard vs Soft Tenancy)을 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', '서비스 카탈로그와 골든 패스(Golden Path) 구축을 설명해주세요.', 'CICD',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:INFRA_CICD', 'K8s Admission Webhook의 종류와 활용을 설명해주세요.', 'KUBERNETES',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:JUNIOR:AWS_K8S:CLOUD', 'AWS의 공동 책임 모델(Shared Responsibility Model)을 설명해주세요.', 'AWS_SECURITY',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:JUNIOR:AWS_K8S:CLOUD', 'AWS IAM의 핵심 개념(사용자, 역할, 정책)을 설명해주세요.', 'AWS_SECURITY',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:JUNIOR:AWS_K8S:CLOUD', 'AWS S3의 스토리지 클래스와 선택 기준을 설명해주세요.', 'AWS_STORAGE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:JUNIOR:AWS_K8S:CLOUD', 'AWS CloudWatch의 기본 기능과 활용을 설명해주세요.', 'AWS_COMPUTE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:JUNIOR:AWS_K8S:CLOUD', 'AWS EC2 인스턴스 타입(범용, 컴퓨팅 최적화, 메모리 최적화)을 설명해주세요.', 'AWS_COMPUTE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:JUNIOR:AWS_K8S:CLOUD', 'AWS Load Balancer의 종류(ALB, NLB, CLB)를 설명해주세요.', 'AWS_NETWORKING',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:JUNIOR:AWS_K8S:CLOUD', 'AWS RDS와 자동 백업, 읽기 복제본을 설명해주세요.', 'AWS_DATABASE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:JUNIOR:AWS_K8S:CLOUD', 'AWS Security Group과 NACL의 차이를 설명해주세요.', 'AWS_NETWORKING',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:JUNIOR:AWS_K8S:CLOUD', 'AWS CloudFront의 개념과 S3 정적 웹사이트 배포를 설명해주세요.', 'AWS_NETWORKING',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:JUNIOR:AWS_K8S:CLOUD', 'AWS Auto Scaling Group의 동작 원리를 설명해주세요.', 'AWS_COMPUTE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:JUNIOR:AWS_K8S:CLOUD', 'AWS Elastic Cache(Redis)의 활용 사례를 설명해주세요.', 'AWS_DATABASE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:JUNIOR:AWS_K8S:CLOUD', 'AWS SQS와 SNS의 차이와 조합 패턴을 설명해주세요.', 'AWS_SERVERLESS',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:JUNIOR:AWS_K8S:CLOUD', 'AWS Lambda의 기본 개념과 콜드 스타트를 설명해주세요.', 'AWS_SERVERLESS',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:JUNIOR:AWS_K8S:CLOUD', 'AWS Route 53의 라우팅 정책을 설명해주세요.', 'AWS_NETWORKING',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:JUNIOR:AWS_K8S:CLOUD', 'AWS KMS(Key Management Service)의 개념과 활용을 설명해주세요.', 'AWS_SECURITY',
...
-- 추가 15문항 (CLOUD MID)
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:CLOUD', 'AWS VPC 설계 시 서브넷 구성 전략을 설명해주세요.', 'AWS_NETWORKING',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:CLOUD', 'AWS ECS Fargate를 활용한 서버리스 컨테이너 배포를 설명해주세요.', 'AWS_COMPUTE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:CLOUD', 'AWS DynamoDB의 파티션 키 설계와 핫 파티션 방지를 설명해주세요.', 'AWS_DATABASE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:CLOUD', 'AWS SQS FIFO와 Standard 큐의 차이를 설명해주세요.', 'AWS_SERVERLESS',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:CLOUD', 'AWS Lambda Layer와 컨테이너 이미지 배포의 장단점을 설명해주세요.', 'AWS_SERVERLESS',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:CLOUD', 'AWS CloudTrail과 Config의 차이와 감사 활용을 설명해주세요.', 'AWS_SECURITY',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:CLOUD', 'AWS Transit Gateway를 활용한 멀티 VPC 네트워킹을 설명해주세요.', 'AWS_NETWORKING',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:CLOUD', 'AWS EKS IRSA(IAM Roles for Service Accounts)를 설명해주세요.', 'AWS_COMPUTE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:CLOUD', 'AWS Secrets Manager와 Parameter Store의 차이를 설명해주세요.', 'AWS_SECURITY',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:CLOUD', 'AWS CDK(Cloud Development Kit)와 CloudFormation의 차이를 설명해주세요.', 'AWS_ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:CLOUD', 'AWS Kinesis Data Streams와 SQS의 차이를 설명해주세요.', 'AWS_SERVERLESS',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:CLOUD', 'AWS MSK(Managed Kafka)를 활용한 이벤트 스트리밍 아키텍처를 설명해주세요.', 'AWS_SERVERLESS',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:CLOUD', 'AWS Cost Allocation Tags와 예산 관리를 설명해주세요.', 'AWS_ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:CLOUD', 'AWS Cognito를 활용한 사용자 인증 구현을 설명해주세요.', 'AWS_SECURITY',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:MID:AWS_K8S:CLOUD', 'AWS S3 이벤트 알림과 Lambda를 연동한 서버리스 파이프라인을 설명해주세요.', 'AWS_SERVERLESS',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:CLOUD', 'AWS에서 Cell-Based Architecture를 구현하는 방법을 설명해주세요.', 'AWS_ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:CLOUD', 'AWS에서 CQRS와 이벤트 소싱 패턴을 구현하는 방법을 설명해주세요.', 'AWS_ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:CLOUD', 'AWS에서 실시간 대용량 데이터 파이프라인을 설계하는 방법을 설명해주세요.', 'AWS_ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:CLOUD', 'AWS Outposts와 Local Zones의 활용 사례를 설명해주세요.', 'AWS_COMPUTE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:CLOUD', 'AWS에서 ML 모델 서빙 아키텍처를 설계하는 방법을 설명해주세요.', 'AWS_ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:CLOUD', 'AWS에서 Database per Service 패턴과 데이터 일관성 관리를 설명해주세요.', 'AWS_ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:CLOUD', 'AWS에서 API Gateway의 고급 기능(Throttling, Caching, Custom Authorizer)을 설명해주세요.', 'AWS_SERVERLESS',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:CLOUD', 'AWS에서 Zero Trust 보안 모델을 구현하는 방법을 설명해주세요.', 'AWS_SECURITY',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:CLOUD', 'AWS에서 GraphQL API(AppSync)를 활용한 아키텍처를 설명해주세요.', 'AWS_SERVERLESS',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:CLOUD', 'AWS SageMaker MLOps 파이프라인을 구축하는 방법을 설명해주세요.', 'AWS_ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:CLOUD', 'AWS에서 고가용성 캐싱 전략(Multi-Layer Cache)을 설명해주세요.', 'AWS_ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:CLOUD', 'AWS에서 서버리스 아키텍처의 관측성(Observability)을 구축하는 방법을 설명해주세요.', 'AWS_SERVERLESS',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:CLOUD', 'AWS 글로벌 가속기(Global Accelerator)와 CloudFront의 차이를 설명해주세요.', 'AWS_NETWORKING',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:CLOUD', 'AWS에서 Bedrock을 활용한 생성형 AI 애플리케이션 아키텍처를 설명해주세요.', 'AWS_ARCHITECTURE',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('DEVOPS:SENIOR:AWS_K8S:CLOUD', 'AWS에서 멀티 계정 보안 자동화(CSPM) 전략을 설명해주세요.', 'AWS_SECURITY',
