...
('SENIOR:BEHAVIORAL', '조직 전체의 기술 협업 방식을 바꾼 경험이 있나요?', '협업',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '글로벌 또는 분산 팀과 협업하며 시너지를 만든 경험을 이야기해주세요.', '협업',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '조직에서 심리적 안전감을 만들기 위해 어떤 노력을 했나요?', '협업',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '여러 프로젝트 팀에 걸친 의존성 문제를 해결한 경험이 있나요?', '협업',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '조직에서 지식 공유 시스템이나 문화를 구축한 경험이 있나요?', '협업',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '엔지니어링 조직과 비즈니스 조직 간 신뢰를 구축한 경험이 있나요?', '협업',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '대규모 시스템 장애를 총괄하여 해결한 경험을 설명해주세요.', '문제해결',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '조직의 기술 전략 방향을 수립하고 실행한 경험이 있나요?', '문제해결',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '기존 모놀리식 시스템을 마이크로서비스로 전환한 경험이 있나요?', '문제해결',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '복잡한 분산 시스템에서 발생한 간헐적 장애를 추적하고 해결한 경험이 있나요?', '문제해결',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '기술 부채와 기능 개발 사이의 균형을 조직 수준에서 관리한 경험이 있나요?', '문제해결',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '고가용성(HA) 또는 재해 복구(DR) 체계를 구축한 경험이 있나요?', '문제해결',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '시니어 엔지니어로서 조직에 기술 문화를 만들거나 변화시킨 경험이 있나요?', '성장',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '기술 리더로 성장하면서 가장 힘들었던 점은 무엇이고 어떻게 극복했나요?', '성장',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '기술 분야 이외의 영역(비즈니스, 조직 관리)을 배우고 성장한 경험이 있나요?', '성장',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '조직 내 다른 시니어 엔지니어와 기술 견해 차이를 극복하고 협력한 경험이 있나요?', '성장',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '실패한 대형 프로젝트에서 조직이 배우게 한 경험이 있나요?', '성장',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '커리어 전반에 걸쳐 기술 외적으로 가장 크게 성장한 영역은 무엇인가요?', '성장',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '조직의 기술 비전을 수립하고 구성원들을 정렬시킨 경험이 있나요?', '리더십',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '권한 위임(Delegation)을 실천하면서 얻은 교훈이 있나요?', '리더십',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '조직 구조 변경(팀 재편, M&A, 리오그)을 기술 관점에서 이끈 경험이 있나요?', '리더십',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '다수의 팀 또는 대규모 프로젝트를 동시에 조율한 경험이 있나요?', '리더십',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '채용과 팀 구성 전략에 직접 참여한 경험이 있나요?', '리더십',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '조직 내 정치적 역학 관계를 다루며 기술적 목표를 달성한 경험이 있나요?', '리더십',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', 'C레벨 또는 이사회에 기술 전략을 발표하고 설득한 경험이 있나요?', '커뮤니케이션',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '기술 조직의 성과와 가치를 외부(경영진, 투자자, 고객)에 효과적으로 알린 경험이 있나요?', '커뮤니케이션',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '어려운 조직 변화(구조조정, 대규모 피벗)를 팀에 투명하게 전달한 경험이 있나요?', '커뮤니케이션',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '기술 컨퍼런스나 외부 무대에서 발표하여 조직의 기술력을 알린 경험이 있나요?', '커뮤니케이션',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '서로 다른 이해관계를 가진 다수의 이해관계자를 한 방향으로 정렬시킨 경험이 있나요?', '커뮤니케이션',
...
INSERT IGNORE INTO question_pool (cache_key, content, category, model_answer, reference_type, is_active, created_at) VALUES
('SENIOR:BEHAVIORAL', '조직의 기술 역량을 외부 채용이 아닌 내부 육성으로 강화한 경험이 있나요?', '커뮤니케이션',
