...
('JUNIOR:SYSTEM_DESIGN', '캐싱(Caching)이란 무엇이고, 왜 사용하나요?', '캐싱(Caching)이란 무엇이고, 왜 사용하나요?', '캐싱',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', 'TTL(Time To Live)이란 무엇이고, 캐시에서 어떻게 활용되나요?', '티티엘(Time To Live)이란 무엇이고, 캐시에서 어떻게 활용되나요?', '캐싱',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', 'Cache Hit와 Cache Miss의 차이는 무엇인가요?', 'Cache Hit와 Cache Miss의 차이는 무엇인가요?', '캐싱',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', 'Cache-Aside 패턴이란 무엇인가요?', 'Cache-Aside 패턴이란 무엇인가요?', '캐싱',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', '메시지 큐(Message Queue)란 무엇이고, 왜 사용하나요?', '메시지 큐(Message Queue)란 무엇이고, 왜 사용하나요?', '메시지큐',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', '동기(Synchronous) 통신과 비동기(Asynchronous) 통신의 차이는 무엇인가요?', '동기(Synchronous) 통신과 비동기(Asynchronous) 통신의 차이는 무엇인가요?', '메시지큐',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', 'Kafka와 RabbitMQ의 기본적인 차이점을 설명해주세요.', '카프카와 래빗엠큐의 기본적인 차이점을 설명해주세요.', '메시지큐',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', '메시지 큐에서 메시지 유실을 방지하는 방법은 무엇인가요?', '메시지 큐에서 메시지 유실을 방지하는 방법은 무엇인가요?', '메시지큐',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', '메시지 큐에서 Consumer가 처리할 수 없는 메시지는 어떻게 처리하나요?', '메시지 큐에서 Consumer가 처리할 수 없는 메시지는 어떻게 처리하나요?', '메시지큐',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', '메시지 큐의 Consumer 수를 늘리면 어떤 효과가 있나요?', '메시지 큐의 Consumer 수를 늘리면 어떤 효과가 있나요?', '메시지큐',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', '마이크로서비스 아키텍처란 무엇이고, 모놀리식과 어떻게 다른가요?', '마이크로서비스 아키텍처란 무엇이고, 모놀리식과 어떻게 다른가요?', '마이크로서비스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', '마이크로서비스 간 통신 방식에는 어떤 것들이 있나요?', '마이크로서비스 간 통신 방식에는 어떤 것들이 있나요?', '마이크로서비스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', 'API Gateway란 무엇이고 마이크로서비스에서 왜 필요한가요?', '에이피아이 Gateway란 무엇이고 마이크로서비스에서 왜 필요한가요?', '마이크로서비스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', '서비스 디스커버리(Service Discovery)가 필요한 이유는 무엇인가요?', '서비스 디스커버리(Service Discovery)가 필요한 이유는 무엇인가요?', '마이크로서비스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', '마이크로서비스에서 데이터베이스를 각 서비스별로 분리하는 이유는 무엇인가요?', '마이크로서비스에서 데이터베이스를 각 서비스별로 분리하는 이유는 무엇인가요?', '마이크로서비스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', 'Circuit Breaker 패턴이란 무엇인가요?', 'Circuit Breaker 패턴이란 무엇인가요?', '마이크로서비스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', '로드밸런싱(Load Balancing)이란 무엇이고 왜 필요한가요?', '로드밸런싱(Load Balancing)이란 무엇이고 왜 필요한가요?', '로드밸런싱',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', '로드밸런싱 알고리즘의 종류와 각각의 특징을 설명해주세요.', '로드밸런싱 알고리즘의 종류와 각각의 특징을 설명해주세요.', '로드밸런싱',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', 'L4 로드밸런서와 L7 로드밸런서의 차이점은 무엇인가요?', 'L4 로드밸런서와 L7 로드밸런서의 차이점은 무엇인가요?', '로드밸런싱',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', 'Sticky Session이란 무엇이고, 어떤 문제가 있나요?', 'Sticky Session이란 무엇이고, 어떤 문제가 있나요?', '로드밸런싱',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', '수평 확장(Scale Out)과 수직 확장(Scale Up)의 차이는 무엇인가요?', '수평 확장(Scale Out)과 수직 확장(Scale Up)의 차이는 무엇인가요?', '로드밸런싱',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', '헬스 체크(Health Check)란 무엇이고 로드밸런서에서 어떻게 활용되나요?', '헬스 체크(Health Check)란 무엇이고 로드밸런서에서 어떻게 활용되나요?', '로드밸런싱',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', 'RESTful API 설계 원칙은 무엇인가요?', 'RESTful 에이피아이 설계 원칙은 무엇인가요?', 'API설계',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', 'HTTP 메서드(GET, POST, PUT, PATCH, DELETE)의 차이점과 올바른 사용법은?', '에이치티티피 메서드(GET, POST, PUT, PATCH, DELETE)의 차이점과 올바른 사용법은?', 'API설계',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', 'API 버전 관리(Versioning)는 왜 필요하고 어떤 방식이 있나요?', '에이피아이 버전 관리(Versioning)는 왜 필요하고 어떤 방식이 있나요?', 'API설계',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', 'API에서 페이지네이션(Pagination)은 왜 필요하고 어떻게 구현하나요?', '에이피아이에서 페이지네이션(Pagination)은 왜 필요하고 어떻게 구현하나요?', 'API설계',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', 'API 인증(Authentication)과 인가(Authorization)의 차이는 무엇인가요?', '에이피아이 인증(Authentication)과 인가(Authorization)의 차이는 무엇인가요?', 'API설계',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('JUNIOR:SYSTEM_DESIGN', 'API에서 에러 응답을 일관성 있게 설계하는 방법은 무엇인가요?', '에이피아이에서 에러 응답을 일관성 있게 설계하는 방법은 무엇인가요?', 'API설계',
