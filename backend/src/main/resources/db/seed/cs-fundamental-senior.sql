...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'LRU 캐시를 O(1) 시간 복잡도로 설계하는 방법과 동시성 처리를 설명해주세요.', '엘알유 캐시를 오 1 시간 복잡도로 설계하는 방법과 동시성 처리를 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'ConcurrentHashMap의 내부 구현(Java 8+)을 설명해주세요.', '컨커런트 해시맵의 내부 구현을 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Skip List의 구조와 장단점을 Red-Black Tree와 비교해주세요.', 'Skip List의 구조와 장단점을 Red-Black Tree와 비교해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Bloom Filter의 원리와 False Positive 확률 제어 방법을 설명해주세요.', 'Bloom Filter의 원리와 False Positive 확률 제어 방법을 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '분산 해시 테이블(DHT)의 구조와 Chord 프로토콜을 설명해주세요.', '분산 해시 테이블(DHT)의 구조와 Chord 프로토콜을 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '실시간 시스템에서 자료구조 선택 시 고려사항을 설명해주세요.', '실시간 시스템에서 자료구조 선택 시 고려사항을 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '대용량 데이터(수십 GB) 정렬 전략을 설명해주세요.', '대용량 데이터(수십 GB) 정렬 전략을 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Lock-Free 자료구조의 원리와 ABA 문제를 설명해주세요.', 'Lock-Free 자료구조의 원리와 ABA 문제를 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Cuckoo Hashing의 원리와 장점을 설명해주세요.', 'Cuckoo Hashing의 원리와 장점을 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Count-Min Sketch의 원리와 활용 사례를 설명해주세요.', 'Count-Min Sketch의 원리와 활용 사례를 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Persistent Data Structure(영속 자료구조)의 개념을 설명해주세요.', 'Persistent Data Structure(영속 자료구조)의 개념을 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'R-Tree의 구조와 공간 인덱싱 활용을 설명해주세요.', 'R-Tree의 구조와 공간 인덱싱 활용을 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Wavelet Tree의 구조와 응용을 설명해주세요.', 'Wavelet Tree의 구조와 응용을 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'LSM(Log-Structured Merge) Tree의 구조와 쓰기 최적화 원리를 설명해주세요.', 'LSM(Log-Structured Merge) Tree의 구조와 쓰기 최적화 원리를 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'CRDT(Conflict-free Replicated Data Type)의 개념과 종류를 설명해주세요.', 'CRDT(Conflict-free Replicated Data Type)의 개념과 종류를 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'HyperLogLog의 원리와 카디널리티 추정 방법을 설명해주세요.', 'HyperLogLog의 원리와 카디널리티 추정 방법을 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Suffix Array와 Suffix Tree의 차이와 활용을 설명해주세요.', 'Suffix Array와 Suffix Tree의 차이와 활용을 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Merkle Tree의 구조와 블록체인에서의 활용을 설명해주세요.', 'Merkle Tree의 구조와 블록체인에서의 활용을 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '분산 정렬(Distributed Sort)의 접근 방법을 설명해주세요.', '분산 정렬(Distributed Sort)의 접근 방법을 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Quotient Filter의 원리와 Bloom Filter와의 비교를 설명해주세요.', 'Quotient Filter의 원리와 Bloom Filter와의 비교를 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'X-fast Trie와 Y-fast Trie의 원리를 설명해주세요.', 'X-fast Trie와 Y-fast Trie의 원리를 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'B-epsilon Tree의 구조와 쓰기 최적화 원리를 설명해주세요.', 'B-epsilon Tree의 구조와 쓰기 최적화 원리를 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '대규모 그래프 처리 시스템(Pregel, GraphX)의 접근 방식을 설명해주세요.', '대규모 그래프 처리 시스템(Pregel, GraphX)의 접근 방식을 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Approximate Nearest Neighbor(ANN) 검색 알고리즘을 비교해주세요.', 'Approximate Nearest Neighbor(ANN) 검색 알고리즘을 비교해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Microkernel과 Monolithic Kernel의 차이와 트레이드오프를 설명해주세요.', 'Microkernel과 Monolithic Kernel의 차이와 트레이드오프를 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'TLB의 구조와 컨텍스트 스위칭 시 성능 영향을 설명해주세요.', 'TLB의 구조와 컨텍스트 스위칭 시 성능 영향을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'NUMA(Non-Uniform Memory Access) 아키텍처의 특징과 최적화를 설명해주세요.', 'NUMA(Non-Uniform Memory Access) 아키텍처의 특징과 최적화를 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '캐시 일관성 프로토콜(MESI)을 설명해주세요.', '캐시 일관성 프로토콜(MESI)을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Banker''s Algorithm(은행원 알고리즘)의 원리와 한계를 설명해주세요.', 'Banker''s Algorithm(은행원 알고리즘)의 원리와 한계를 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '메모리 매핑 파일의 고급 활용과 주의사항을 설명해주세요.', '메모리 매핑 파일의 고급 활용과 주의사항을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Copy-on-Write의 고급 활용과 커널 수준 구현을 설명해주세요.', 'Copy-on-Write의 고급 활용과 커널 수준 구현을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'CFS(Completely Fair Scheduler)의 한계와 대안을 설명해주세요.', 'CFS(Completely Fair Scheduler)의 한계와 대안을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'io_uring의 원리와 기존 I/O 모델 대비 장점을 설명해주세요.', 'io_uring의 원리와 기존 I/O 모델 대비 장점을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'cgroups와 namespace의 차이와 컨테이너에서의 역할을 설명해주세요.', 'cgroups와 namespace의 차이와 컨테이너에서의 역할을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Huge Pages의 장점과 사용 시 고려사항을 설명해주세요.', 'Huge Pages의 장점과 사용 시 고려사항을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'RCU(Read-Copy-Update)의 원리와 Linux 커널에서의 활용을 설명해주세요.', 'RCU(Read-Copy-Update)의 원리와 Linux 커널에서의 활용을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'eBPF(Extended Berkeley Packet Filter)의 개념과 활용을 설명해주세요.', 'eBPF(Extended Berkeley Packet Filter)의 개념과 활용을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Memory Ordering과 Memory Barrier의 개념을 설명해주세요.', 'Memory Ordering과 Memory Barrier의 개념을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Spectre/Meltdown 취약점의 원리와 OS 수준 대응을 설명해주세요.', 'Spectre/Meltdown 취약점의 원리와 오에스 수준 대응을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'DPDK(Data Plane Development Kit)의 원리와 장점을 설명해주세요.', 'DPDK(Data Plane Development Kit)의 원리와 장점을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Page Cache와 Buffer Cache의 차이와 통합을 설명해주세요.', 'Page Cache와 Buffer Cache의 차이와 통합을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'seccomp과 AppArmor/SELinux의 차이와 컨테이너 보안에서의 역할을 설명해주세요.', 'seccomp과 AppArmor/SELinux의 차이와 컨테이너 보안에서의 역할을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'OOM Killer의 동작 원리와 제어 방법을 설명해주세요.', 'OOM Killer의 동작 원리와 제어 방법을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'CPU 캐시 최적화(Cache-Oblivious vs Cache-Aware)를 설명해주세요.', '씨피유 캐시 최적화(Cache-Oblivious vs Cache-Aware)를 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'futex(Fast Userspace Mutex)의 원리를 설명해주세요.', 'futex(Fast Userspace Mutex)의 원리를 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Kernel Same-page Merging(KSM)의 원리와 활용을 설명해주세요.', 'Kernel Same-page Merging(KSM)의 원리와 활용을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'QUIC 프로토콜의 내부 구조와 TCP 대비 장점을 상세히 설명해주세요.', 'QUIC 프로토콜의 내부 구조와 티씨피 대비 장점을 상세히 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Zero Trust Architecture의 원칙과 구현 방법을 설명해주세요.', 'Zero Trust Architecture의 원칙과 구현 방법을 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'DDoS 공격 유형과 방어 전략을 설명해주세요.', 'DDoS 공격 유형과 방어 전략을 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'CDN 캐싱 전략과 캐시 무효화 방법을 설명해주세요.', '씨디엔 캐싱 전략과 캐시 무효화 방법을 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'TCP Fast Open(TFO)의 원리와 보안 고려사항을 설명해주세요.', '티씨피 Fast Open(TFO)의 원리와 보안 고려사항을 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'WebSocket vs SSE vs gRPC Streaming의 선택 기준을 설명해주세요.', '웹소켓 vs 에스에스이 vs gRPC Streaming의 선택 기준을 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'gRPC vs REST 선택 기준을 성능, 유지보수, 생태계 관점에서 비교해주세요.', 'gRPC vs 레스트 선택 기준을 성능, 유지보수, 생태계 관점에서 비교해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'BGP(Border Gateway Protocol)의 역할과 BGP Hijacking을 설명해주세요.', 'BGP(Border Gateway Protocol)의 역할과 BGP Hijacking을 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'mTLS(Mutual TLS)의 원리와 서비스 메시에서의 활용을 설명해주세요.', 'mTLS(Mutual TLS)의 원리와 서비스 메시에서의 활용을 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'TCP BBR(Bottleneck Bandwidth and RTT) 혼잡 제어의 원리를 설명해주세요.', '티씨피 BBR(Bottleneck Bandwidth and RTT) 혼잡 제어의 원리를 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Network Partition 시 분산 시스템의 대응 전략을 설명해주세요.', 'Network Partition 시 분산 시스템의 대응 전략을 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'DNS over HTTPS(DoH)와 DNS over TLS(DoT)의 차이와 의의를 설명해주세요.', '디엔에스 over 에이치티티피에스(DoH)와 디엔에스 over 티엘에스(DoT)의 차이와 의의를 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Anycast의 원리와 CDN/DNS에서의 활용을 설명해주세요.', 'Anycast의 원리와 씨디엔/디엔에스에서의 활용을 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'SRv6(Segment Routing over IPv6)의 개념과 장점을 설명해주세요.', 'SRv6(Segment Routing over IPv6)의 개념과 장점을 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'HTTP/3의 0-RTT 연결과 Replay Attack 위험을 설명해주세요.', '에이치티티피/3의 0-RTT 연결과 Replay Attack 위험을 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'ECMP(Equal-Cost Multi-Path)와 트래픽 엔지니어링을 설명해주세요.', 'ECMP(Equal-Cost Multi-Path)와 트래픽 엔지니어링을 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Service Mesh(Istio, Linkerd)의 아키텍처와 장단점을 설명해주세요.', 'Service Mesh(Istio, Linkerd)의 아키텍처와 장단점을 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'XDP(eXpress Data Path)의 원리와 네트워크 성능 최적화를 설명해주세요.', 'XDP(eXpress Data Path)의 원리와 네트워크 성능 최적화를 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Connection Draining과 Graceful Shutdown의 구현을 설명해주세요.', 'Connection Draining과 Graceful Shutdown의 구현을 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Envoy Proxy의 아키텍처와 핵심 기능을 설명해주세요.', 'Envoy Proxy의 아키텍처와 핵심 기능을 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'DPDK와 RDMA의 차이와 고성능 네트워크에서의 활용을 설명해주세요.', 'DPDK와 RDMA의 차이와 고성능 네트워크에서의 활용을 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'CAP 정리와 PACELC 확장 모델을 설명해주세요.', 'CAP 정리와 PACELC 확장 모델을 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'BASE 이론과 Eventual Consistency의 구현 방법을 설명해주세요.', 'BASE 이론과 Eventual Consistency의 구현 방법을 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '분산 트랜잭션의 2PC와 Saga 패턴을 비교해주세요.', '분산 트랜잭션의 2PC와 Saga 패턴을 비교해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'MVCC의 구현 방식을 InnoDB와 PostgreSQL에서 비교해주세요.', 'MVCC의 구현 방식을 이노디비와 포스트그레스큐엘에서 비교해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Consistent Hashing을 활용한 데이터베이스 샤딩과 리밸런싱을 설명해주세요.', 'Consistent Hashing을 활용한 데이터베이스 샤딩과 리밸런싱을 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '쿼리 캐싱 전략과 Cache Invalidation 패턴을 설명해주세요.', '쿼리 캐싱 전략과 Cache Invalidation 패턴을 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'NoSQL 데이터베이스 선택 기준과 각 유형의 데이터 모델 특성을 설명해주세요.', 'NoSQL 데이터베이스 선택 기준과 각 유형의 데이터 모델 특성을 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Elasticsearch의 역인덱스(Inverted Index) 구조를 상세히 설명해주세요.', '엘라스틱서치의 역인덱스(Inverted Index) 구조를 상세히 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '시계열 데이터베이스(TSDB)의 특성과 저장 최적화를 설명해주세요.', '시계열 데이터베이스(TSDB)의 특성과 저장 최적화를 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '데이터 웨어하우스와 데이터 레이크의 차이와 Lakehouse 아키텍처를 설명해주세요.', '데이터 웨어하우스와 데이터 레이크의 차이와 Lakehouse 아키텍처를 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Change Data Capture(CDC)의 구현 방법과 활용을 설명해주세요.', 'Change Data Capture(CDC)의 구현 방법과 활용을 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Raft 합의 알고리즘의 원리와 Paxos 대비 장점을 설명해주세요.', 'Raft 합의 알고리즘의 원리와 Paxos 대비 장점을 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'CockroachDB와 Spanner의 분산 SQL 아키텍처를 설명해주세요.', 'CockroachDB와 Spanner의 분산 에스큐엘 아키텍처를 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Quorum 기반 복제에서 R+W>N 조건의 의미와 트레이드오프를 설명해주세요.', 'Quorum 기반 복제에서 R+W>N 조건의 의미와 트레이드오프를 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Vector Database의 아키텍처와 LLM 활용을 설명해주세요.', 'Vector Database의 아키텍처와 LLM 활용을 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '대규모 마이그레이션(스키마 변경) 시 무중단 전략을 설명해주세요.', '대규모 마이그레이션(스키마 변경) 시 무중단 전략을 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Multi-Tenant 데이터베이스 설계 전략을 비교해주세요.', 'Multi-Tenant 데이터베이스 설계 전략을 비교해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Write-Ahead Log(WAL)의 성능 최적화와 Group Commit을 설명해주세요.', 'Write-Ahead Log(WAL)의 성능 최적화와 Group Commit을 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Vitess와 같은 데이터베이스 프록시의 아키텍처와 장점을 설명해주세요.', 'Vitess와 같은 데이터베이스 프록시의 아키텍처와 장점을 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Columnar Storage와 Row Storage의 차이와 OLAP에서의 장점을 설명해주세요.', 'Columnar Storage와 Row Storage의 차이와 OLAP에서의 장점을 설명해주세요.', '데이터베이스',
...
-- 자료구조 추가 (8문항)
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Van Emde Boas Tree의 구조와 시간 복잡도를 설명해주세요.', 'Van Emde Boas Tree의 구조와 시간 복잡도를 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Fibonacci Heap의 구조와 Decrease-Key 연산의 amortized 복잡도를 설명해주세요.', 'Fibonacci Heap의 구조와 Decrease-Key 연산의 amortized 복잡도를 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Treap(Tree + Heap)의 구조와 무작위화 BST로서의 특성을 설명해주세요.', 'Treap(Tree + Heap)의 구조와 무작위화 BST로서의 특성을 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '링크드 해시맵(LinkedHashMap)의 내부 구현과 LFU 캐시 설계에 활용하는 방법을 설명해주세요.', '링크드 해시맵(LinkedHashMap)의 내부 구현과 LFU 캐시 설계에 활용하는 방법을 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Disjoint Set(Union-Find)을 활용한 온라인 연결성 쿼리(Dynamic Connectivity)를 설명해주세요.', 'Disjoint Set(Union-Find)을 활용한 온라인 연결성 쿼리(Dynamic Connectivity)를 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Weight-Balanced Tree의 리밸런싱 전략과 함수형 자료구조에서의 활용을 설명해주세요.', 'Weight-Balanced Tree의 리밸런싱 전략과 함수형 자료구조에서의 활용을 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '이분 매칭(Bipartite Matching)과 최대 유량(Max Flow) 알고리즘의 관계를 설명해주세요.', '이분 매칭(Bipartite Matching)과 최대 유량(Max Flow) 알고리즘의 관계를 설명해주세요.', '자료구조',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '확률적 자료구조(Probabilistic Data Structure)의 공간-정확도 트레이드오프를 설명해주세요.', '확률적 자료구조(Probabilistic Data Structure)의 공간-정확도 트레이드오프를 설명해주세요.', '자료구조',
...
-- 운영체제 추가 (9문항)
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Linux 커널의 메모리 존(Memory Zone) 구조와 슬랩 할당자(Slab Allocator)를 설명해주세요.', 'Linux 커널의 메모리 존(Memory Zone) 구조와 슬랩 할당자(Slab Allocator)를 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'CPU 분기 예측(Branch Prediction)의 원리와 최신 CPU에서의 구현을 설명해주세요.', '씨피유 분기 예측(Branch Prediction)의 원리와 최신 씨피유에서의 구현을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Linux cgroups v2의 계층 구조와 리소스 제한 메커니즘을 설명해주세요.', 'Linux cgroups v2의 계층 구조와 리소스 제한 메커니즘을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'CPU 파이프라인 해저드(Hazard)의 종류와 하드웨어/소프트웨어 해결 방법을 설명해주세요.', '씨피유 파이프라인 해저드(Hazard)의 종류와 하드웨어/소프트웨어 해결 방법을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Linux 신호(Signal)의 전달 메커니즘과 비동기 안전(Async-Signal-Safe) 함수를 설명해주세요.', 'Linux 신호(Signal)의 전달 메커니즘과 비동기 안전(Async-Signal-Safe) 함수를 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Non-Uniform Memory Access(NUMA)와 NUMA-aware 소프트웨어 설계를 설명해주세요.', 'Non-Uniform Memory Access(NUMA)와 NUMA-aware 소프트웨어 설계를 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '커널 바이패스(Kernel Bypass) 기술과 RDMA의 원리를 설명해주세요.', '커널 바이패스(Kernel Bypass) 기술과 RDMA의 원리를 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Linux perf와 flame graph를 활용한 CPU 프로파일링 방법을 설명해주세요.', 'Linux perf와 flame graph를 활용한 씨피유 프로파일링 방법을 설명해주세요.', '운영체제',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'POSIX 스레드(pthread)와 Go Goroutine의 스케줄링 모델 차이를 설명해주세요.', 'POSIX 스레드(pthread)와 Go Goroutine의 스케줄링 모델 차이를 설명해주세요.', '운영체제',
...
-- 네트워크 추가 (8문항)
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'TCP 혼잡 제어 알고리즘의 진화(CUBIC, BBR, QUIC)를 설명해주세요.', '티씨피 혼잡 제어 알고리즘의 진화(CUBIC, BBR, QUIC)를 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'HTTP/2 서버 푸시(Server Push)의 동작 원리와 실제 활용 한계를 설명해주세요.', '에이치티티피/2 서버 푸시(Server Push)의 동작 원리와 실제 활용 한계를 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'NAT(Network Address Translation)의 동작 방식과 P2P 연결에서의 NAT 트래버설을 설명해주세요.', 'NAT(Network Address Translation)의 동작 방식과 P2P 연결에서의 NAT 트래버설을 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Rate Limiting 알고리즘(Token Bucket, Leaky Bucket, Sliding Window)을 비교해주세요.', 'Rate Limiting 알고리즘(Token Bucket, Leaky Bucket, Sliding Window)을 비교해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'TLS 1.3의 핸드셰이크 개선 사항과 0-RTT의 보안 트레이드오프를 설명해주세요.', '티엘에스 1.3의 핸드셰이크 개선 사항과 0-RTT의 보안 트레이드오프를 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '마이크로서비스 환경에서 서비스 디스커버리(Service Discovery) 패턴을 설명해주세요.', '마이크로서비스 환경에서 서비스 디스커버리(Service Discovery) 패턴을 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '네트워크 패킷 캡처와 분석(Wireshark/tcpdump)을 통한 트러블슈팅 방법을 설명해주세요.', '네트워크 패킷 캡처와 분석(Wireshark/tcpdump)을 통한 트러블슈팅 방법을 설명해주세요.', '네트워크',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'WebRTC의 아키텍처와 미디어 전송 최적화 방법을 설명해주세요.', 'WebRTC의 아키텍처와 미디어 전송 최적화 방법을 설명해주세요.', '네트워크',
...
-- 데이터베이스 추가 (8문항)
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'PostgreSQL의 MVCC 구현과 Vacuum의 역할을 MySQL InnoDB와 비교하여 설명해주세요.', '포스트그레스큐엘의 MVCC 구현과 Vacuum의 역할을 마이에스큐엘 이노디비와 비교하여 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '데이터베이스 인덱스의 내부 구조(InnoDB B+Tree 페이지 구조)를 상세히 설명해주세요.', '데이터베이스 인덱스의 내부 구조(InnoDB B+Tree 페이지 구조)를 상세히 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '분산 데이터베이스에서 Lamport Clock과 Vector Clock의 인과성 추적을 설명해주세요.', '분산 데이터베이스에서 Lamport Clock과 Vector Clock의 인과성 추적을 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'NewSQL 데이터베이스(CockroachDB, TiDB)의 아키텍처와 전통적 RDBMS 대비 장단점을 설명해주세요.', 'NewSQL 데이터베이스(CockroachDB, TiDB)의 아키텍처와 전통적 RDBMS 대비 장단점을 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '데이터베이스 커넥션 풀 튜닝과 HikariCP 설정 전략을 설명해주세요.', '데이터베이스 커넥션 풀 튜닝과 HikariCP 설정 전략을 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', '대규모 트래픽 환경에서 데이터베이스 읽기 확장(Read Scaling) 전략을 설명해주세요.', '대규모 트래픽 환경에서 데이터베이스 읽기 확장(Read Scaling) 전략을 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'MySQL InnoDB의 버퍼 풀(Buffer Pool) 아키텍처와 튜닝 전략을 설명해주세요.', '마이에스큐엘 이노디비의 버퍼 풀(Buffer Pool) 아키텍처와 튜닝 전략을 설명해주세요.', '데이터베이스',
...
INSERT IGNORE INTO question_pool (cache_key, content, tts_content, category, model_answer, is_active, created_at) VALUES
('SENIOR:CS_FUNDAMENTAL', 'Event Sourcing과 CQRS 패턴을 데이터베이스 설계 관점에서 설명해주세요.', 'Event Sourcing과 씨큐알에스 패턴을 데이터베이스 설계 관점에서 설명해주세요.', '데이터베이스',
