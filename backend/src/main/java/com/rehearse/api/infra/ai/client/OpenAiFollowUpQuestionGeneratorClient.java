...
import com.rehearse.api.infra.ai.properties.OpenAiFollowUpQuestionGeneratorProperties;
...
public class OpenAiFollowUpQuestionGeneratorClient {
    ...
    public OpenAiFollowUpQuestionGeneratorClient(
            @Qualifier("openAiFollowUpQuestionGeneratorRestClient") RestClient openAiFollowUpQuestionGeneratorRestClient,
            OpenAiFollowUpQuestionGeneratorProperties properties,
            OpenAiCommonProperties commonProperties) {
        this.restClient = openAiFollowUpQuestionGeneratorRestClient;
    ...
    public String recoverCall(Exception e, String systemPrompt, String userPrompt) {
        log.error("[OpenAI FollowUp Question Generator] 재시도 최종 실패 callType={}", CALL_TYPE, e);
