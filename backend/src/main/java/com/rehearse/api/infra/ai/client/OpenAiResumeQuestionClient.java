...
public class OpenAiResumeQuestionClient {

    private static final String CALL_TYPE = "resume_question_generator";

    private final RestClient restClient;
    private final OpenAiResumeQuestionProperties properties;
    private final String apiKey;

    public OpenAiResumeQuestionClient(
            @Qualifier("openAiResumeQuestionRestClient") RestClient openAiResumeQuestionRestClient,
            OpenAiResumeQuestionProperties properties,
            OpenAiCommonProperties commonProperties) {
        this.restClient = openAiResumeQuestionRestClient;
    ...
    public String recoverCall(Exception e, String systemPrompt, String userPrompt) {
        log.error("[OpenAI Resume Question] 재시도 최종 실패 callType={}", CALL_TYPE, e);
