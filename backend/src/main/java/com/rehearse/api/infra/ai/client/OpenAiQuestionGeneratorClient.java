...
import com.rehearse.api.infra.ai.config.OpenAiQuestionGeneratorProperties;
...
public class OpenAiQuestionGeneratorClient {

    private static final String CALL_TYPE = "generate_questions";

    private final RestClient restClient;
    private final OpenAiQuestionGeneratorProperties properties;
    private final String apiKey;

    public OpenAiQuestionGeneratorClient(
            @Qualifier("openAiQuestionGeneratorRestClient") RestClient openAiQuestionGeneratorRestClient,
            OpenAiQuestionGeneratorProperties properties,
            OpenAiCommonProperties commonProperties) {
        this.restClient = openAiQuestionGeneratorRestClient;
    ...
    public String recoverCall(Exception e, String systemPrompt, String userPrompt) {
        log.error("[OpenAI Question Generator] 재시도 최종 실패 callType={}", CALL_TYPE, e);
