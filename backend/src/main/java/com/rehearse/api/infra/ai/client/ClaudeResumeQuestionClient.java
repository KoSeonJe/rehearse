...
import com.rehearse.api.infra.ai.properties.ClaudeResumeQuestionProperties;
...
public class ClaudeResumeQuestionClient {

    private static final String CALL_TYPE = "resume_question_generator";
    private static final String ANTHROPIC_VERSION = "2023-06-01";

    private final RestClient restClient;
    private final ClaudeResumeQuestionProperties properties;
    private final String apiKey;

    public ClaudeResumeQuestionClient(
            @Qualifier("claudeResumeQuestionRestClient") RestClient claudeResumeQuestionRestClient,
            ClaudeResumeQuestionProperties properties,
            @Value("${claude.api-key}") String apiKey) {
        this.restClient = claudeResumeQuestionRestClient;
    ...
    public String recoverCall(Exception e, String systemPrompt, String userPrompt) {
        log.error("[Claude Resume Question] 재시도 최종 실패 callType={}", CALL_TYPE, e);
