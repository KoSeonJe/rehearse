...
import com.rehearse.api.infra.ai.config.ClaudeQuestionGeneratorProperties;
...
public class ClaudeQuestionGeneratorClient {

    private static final String CALL_TYPE = "generate_questions";
    private static final String ANTHROPIC_VERSION = "2023-06-01";

    private final RestClient restClient;
    private final ClaudeQuestionGeneratorProperties properties;
    private final String apiKey;

    public ClaudeQuestionGeneratorClient(
            @Qualifier("claudeQuestionGeneratorRestClient") RestClient claudeQuestionGeneratorRestClient,
            ClaudeQuestionGeneratorProperties properties,
            @Value("${claude.api-key}") String apiKey) {
        this.restClient = claudeQuestionGeneratorRestClient;
    ...
    public String recoverCall(Exception e, String systemPrompt, String userPrompt) {
        log.error("[Claude Question Generator] 재시도 최종 실패 callType={}", CALL_TYPE, e);
