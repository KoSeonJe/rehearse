...
import com.rehearse.api.infra.ai.config.OpenAiRubricScorerProperties;
...
public class OpenAiRubricScorerClient {

    private static final String CALL_TYPE = "rubric_scoring";

    private final RestClient restClient;
    private final OpenAiRubricScorerProperties properties;
    private final String apiKey;

    public OpenAiRubricScorerClient(
            @Qualifier("openAiRubricScorerRestClient") RestClient openAiRubricScorerRestClient,
            OpenAiRubricScorerProperties properties,
            OpenAiCommonProperties commonProperties) {
        this.restClient = openAiRubricScorerRestClient;
    ...
    public String call(String systemPrompt, String userPrompt, @Nullable Map<String, Object> jsonSchema) {
        Map<String, Object> body = buildRequestBody(systemPrompt, userPrompt, jsonSchema);
        return execute(body);
    }
    ...
    public String recoverCall(Exception e, String systemPrompt, String userPrompt,
        ...
        log.error("[OpenAI Rubric Scorer] 재시도 최종 실패 callType={}", CALL_TYPE, e);
    ...
    private Map<String, Object> buildRequestBody(
        ...
        if (jsonSchema != null) {
            body.put("response_format", Map.of(
                    "type", "json_schema",
                    "json_schema", Map.of(
                            "name", RubricScorerPromptBuilder.SCHEMA_NAME,
                            "strict", true,
                            "schema", jsonSchema
                    )
            ));
