...
public class ClaudeAnswerAnalyzerClient {

    private static final String CALL_TYPE = "answer_analyzer";
    private static final String ANTHROPIC_VERSION = "2023-06-01";

    private final RestClient restClient;
    private final ClaudeAnswerAnalyzerProperties properties;
    private final String apiKey;

    public ClaudeAnswerAnalyzerClient(
            @Qualifier("claudeAnswerAnalyzerRestClient") RestClient claudeAnswerAnalyzerRestClient,
            ClaudeAnswerAnalyzerProperties properties,
            @Value("${claude.api-key}") String apiKey) {
        this.restClient = claudeAnswerAnalyzerRestClient;
    ...
    public String recoverCall(Exception e, String systemPrompt, String userPrompt) {
        log.error("[Claude Answer Analyzer] 재시도 최종 실패 callType={}", CALL_TYPE, e);
