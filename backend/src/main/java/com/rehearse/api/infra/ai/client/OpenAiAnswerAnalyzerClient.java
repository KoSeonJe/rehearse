...
import com.rehearse.api.infra.ai.config.OpenAiAnswerAnalyzerProperties;
...
public class OpenAiAnswerAnalyzerClient {

    private static final String CALL_TYPE = "answer_analyzer";

    private final RestClient restClient;
    private final OpenAiAnswerAnalyzerProperties properties;
    private final String apiKey;

    public OpenAiAnswerAnalyzerClient(
            @Qualifier("openAiAnswerAnalyzerRestClient") RestClient openAiAnswerAnalyzerRestClient,
            OpenAiAnswerAnalyzerProperties properties,
            OpenAiCommonProperties commonProperties) {
        this.restClient = openAiAnswerAnalyzerRestClient;
    ...
    public String recoverCall(Exception e, String systemPrompt, String userPrompt) {
        log.error("[OpenAI Answer Analyzer] 재시도 최종 실패 callType={}", CALL_TYPE, e);
