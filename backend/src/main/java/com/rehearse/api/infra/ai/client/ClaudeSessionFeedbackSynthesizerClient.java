...
import com.rehearse.api.infra.ai.config.ClaudeSessionFeedbackSynthesizerProperties;
...
public class ClaudeSessionFeedbackSynthesizerClient {

    private static final String CALL_TYPE = "session_feedback_synthesizer";
    private static final String ANTHROPIC_VERSION = "2023-06-01";

    private final RestClient restClient;
    private final ClaudeSessionFeedbackSynthesizerProperties properties;
    private final String apiKey;

    public ClaudeSessionFeedbackSynthesizerClient(
            @Qualifier("claudeSessionFeedbackSynthesizerRestClient") RestClient claudeSessionFeedbackSynthesizerRestClient,
            ClaudeSessionFeedbackSynthesizerProperties properties,
            @Value("${claude.api-key}") String apiKey) {
        this.restClient = claudeSessionFeedbackSynthesizerRestClient;
    ...
    public String recoverCall(Exception e, String systemPrompt, String userPrompt) {
        log.error("[Claude Session Feedback Synthesizer] 재시도 최종 실패 callType={}", CALL_TYPE, e);
