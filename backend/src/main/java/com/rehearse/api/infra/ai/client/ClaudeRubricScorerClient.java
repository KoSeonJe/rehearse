...
import com.rehearse.api.infra.ai.config.ClaudeRubricScorerProperties;
...
public class ClaudeRubricScorerClient {

    private static final String CALL_TYPE = "rubric_scoring";
    private static final String ANTHROPIC_VERSION = "2023-06-01";

    private final RestClient restClient;
    private final ClaudeRubricScorerProperties properties;
    private final String apiKey;

    public ClaudeRubricScorerClient(
            @Qualifier("claudeRubricScorerRestClient") RestClient claudeRubricScorerRestClient,
            ClaudeRubricScorerProperties properties,
            @Value("${claude.api-key}") String apiKey) {
        this.restClient = claudeRubricScorerRestClient;
    ...
    public String recoverCall(Exception e, String systemPrompt, String userPrompt) {
        log.error("[Claude Rubric Scorer] 재시도 최종 실패 callType={}", CALL_TYPE, e);
